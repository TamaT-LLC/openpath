...
struct PasteboardSnapshotTests {
    ...
    @Test("nspasteboard.org の印の型名")
    func markerTypesFollowNSPasteboardOrg() {
        #expect(PasteboardSnapshot.concealedMarkerType == "org.nspasteboard.ConcealedType")
        #expect(PasteboardSnapshot.autoGeneratedMarkerType == "org.nspasteboard.AutoGeneratedType")
    }
}
